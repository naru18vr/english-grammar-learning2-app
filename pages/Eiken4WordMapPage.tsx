...
const Eiken4WordMapPage: React.FC = () => {
  ...
  return <div className="flex-grow container mx-auto p-4 sm:p-6 max-w-3xl"><Button onClick={() => navigate('/eiken4')} variant="ghost" size="sm"><ArrowLeftIcon className="h-5 w-5 mr-2" />英検4級に戻る</Button>
    <header className="mt-4 rounded-2xl bg-indigo-600 text-white p-6 shadow-lg"><p className="text-sm font-bold opacity-90">全128語</p><h1 className="text-3xl font-bold mt-1">英単語マップ</h1><p className="text-sm mt-2 opacity-90">異なる4日で正解し、直近も正解した単語だけ「覚えた」になります。同じ日の複数正解は1日分です。</p></header>
