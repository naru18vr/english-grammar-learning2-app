...
const Eiken4ReadingPage: React.FC = () => {
  ...
  return <div className="flex-grow container mx-auto p-4 sm:p-6 max-w-2xl">
    ...
    <header className="rounded-xl bg-sky-600 text-white p-5 shadow-lg">
      <p className="text-sm font-bold opacity-90">今日のミニ長文・{reading.type}</p><h1 className="text-2xl font-bold mt-1">{reading.title}</h1>
    </header>
